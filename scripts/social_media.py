...
def main():
    ...
    for m in media:
      ...
      if ('youtube' in social) or ('youtube_id' in social):
        ...
        try:
          ...
          ytreq = safe_requests.get(profile_url)
          ...
          if ytreq.status_code == 404:
            ...
            try:
              ...
              csearch = safe_requests.get(search_url).text.encode('ascii','ignore')
  ...
  def resolveig():
    ...
    for m in media:
      ...
      instagram_user_search = safe_requests.get(query_url).json()
